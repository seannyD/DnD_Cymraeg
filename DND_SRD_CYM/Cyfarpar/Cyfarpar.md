# Cyfarpar (Adventuring Gear)

This section describes items that have special rules or require further explanation.

***Acid***. As an action, you can splash the contents of this vial onto a creature within 5 feet of you or throw the vial up to 20 feet, shattering it on impact. In either case, make a ranged attack against a creature or object, treating the acid (asid) as an improvised weapon. On a hit, the target takes 2d6 acid (asid) damage.

***Alchemist's Fire***. This sticky, adhesive fluid ignites when exposed to air. As an action, you can throw this flask up to 20 feet, shattering it on impact. Make a ranged attack against a creature or object, treating the alchemist's fire (tân) as an improvised weapon. On a hit, the target takes 1d4 fire (tân) damage at the start of each of its turns. A creature can end this damage by using its action to make a DC 10 Dexterity check to extinguish the flames.

***Antitoxin***. A creature that drinks this vial of liquid gains advantage on saving throws against poison (gwenwyn) am un awr. It confers no benefit to undead or constructs.
...
***Caltrops***. As an action, you can spread a bag of caltrops to cover a square area that is 5 feet on a side. Any creature that enters the area llwyddo ar cais achub Chwimder DC 15 or stop moving this turn and take 1 piercing (tyllu) damage. Taking this damage reduces the creature's walking speed by 10 feet until the creature regains at least 1 hit point. A creature moving through the area at half speed doesn't need to make the save.
...
***Holy Water***. As an action, you can splash the contents of this flask onto a creature within 5 feet of you or throw it up to 20 feet, shattering it on impact. In either case, make a ranged attack against a target creature, treating the holy water as an improvised weapon. If the target is a fiend or undead, it takes 2d6 radiant (pelydrol) damage. A cleric or paladin may create holy water by performing a special ritual. The ritual takes 1 hour to perform, uses 25 gp worth of powdered silver, and requires the caster to expend a 1st-level spell slot.

***Hunting Trap***. When you use your action to set it, this trap forms a saw-toothed steel ring that snaps shut when a creature steps on a pressure plate in the center. The trap is affixed by a heavy chain to an immobile object, such as a tree or a spike (peic) driven into the ground. A creature that steps on the plate llwyddo ar cais achub Chwimder DC 13 or take 1d4 piercing (tyllu) damage and stop moving. Thereafter, until the creature breaks free of the trap, its movement is limited by the length of the chain (typically 3 feet long). A creature can use its action to make a DC 13 Strength check, freeing itself or another creature within its reach on a success. Each failed check deals 1 piercing (tyllu) damage to the trapped creature.
...
***Magnifying Glass***. This lens allows a closer look at small objects. It is also useful as a substitute for flint and steel when starting fire (tân)s. Lighting a fire (tân) with a magnifying glass requires light as bright as sunlight to focus, tinder to ignite, and about 5 minutes for the fire (tân) to ignite. A magnifying glass grants advantage on any ability check made to appraise or inspect an item that is small or highly detailed.
...
***Oil***. Oil usually comes in a clay flask that holds 1 pint. As an action, you can splash the oil in this flask onto a creature within 5 feet of you or throw it up to 20 feet, shattering it on impact. Make a ranged attack against a target creature or object, treating the oil as an improvised weapon. On a hit, the target is covered in oil. If the target takes any fire (tân) damage before the oil dries (after 1 minute), the target takes an additional 5 fire (tân) damage from the burning oil. You can also pour a flask of oil on the ground to cover a 5-foot square area, provided that the surface is level. If lit, the oil burns for 2 rounds and deals 5 fire (tân) damage to any creature that enters the area or ends its turn in the area. A creature can take this damage only once per turn.

***Poison, Basic***. You can use the poison (gwenwyn) in this vial to coat one slashing (slasio) or piercing (tyllu) weapon or up to three pieces of ammunition. Applying the poison (gwenwyn) takes an action. A creature hit by the poison (gwenwyn)ed (gwenwyno) weapon or ammunition llwyddo ar cais achub Cyfansoddiad DC 10 or take 1d4 poison (gwenwyn) damage. Once applied, the poison (gwenwyn) retains potency am un munud before drying.
...
***Scale, Merchant's***. A scale includes a small balance (lans), pans, and a suitable assortment of weights up to 2 pounds. With it, you can measure the exact weight of small objects, such as raw precious metals or trade goods, to help determine their worth.
...
***Tinderbox***. This small container holds flint, fire (tân) steel, and tinder (usually dry cloth soaked in light oil) used to kindle a fire (tân). Using it to light a torch-or anything else with abundant, exposed fuel-takes an action. Lighting any other fire (tân) takes 1 minute.

***Torch***. A torch burns am un awr, providing bright light in a 20-foot radius and dim light for an additional 20 feet. If you make a melee attack with a burning torch and hit, it deals 1 fire (tân) damage.
...
| Alchemist's fire (tân) (flask)     | 50 gp    | 1 lb.        |
| *Ammunition*                 |          |              |
| ~ Arrows (20)                | 1 gp     | 1 lb.        |
| ~ Blowgun (Gwn saeth) needles (50)       | 1 gp     | 1 lb.        |
| ~ Crossbow bolts (20)        | 1 gp     | 1½ lb.       |
| ~ Sling (Sling) bullets (20)         | 4 cp     | 1½ lb.       |
...
| Shovel                       | 2 gp     | 5 lb.        |
| Signal whistle               | 5 cp     | -            |
| Signet (rhwyd) ring                  | 5 gp     | -            |
| Soap                         | 2 cp     | -            |
| Spellbook                    | 50 gp    | 3 lb.        |
| Spike (peic)s (peics), iron (10)            | 1 gp     | 5 lb.        |
