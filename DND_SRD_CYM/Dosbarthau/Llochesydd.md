...
**Dis Heini:** 1d8 per warlock level

**Pwyntiau Heini ar lefel 1:** 8 + eich newidyn Cyfansoddiad

**Pwyntiau Heini ar lefelau uwch:** 1d8 (or 5) + eich newidyn Cyfansoddiad per warlock level after 1st
...
**Sgiliau:** Dewiswch dau sgil o Hud a Lledrith, Twyll, Hanes, Brawychu, Ymchwilio, Natur, ac Crefydd
...
Charisma (Presenoldeb) is your spellcasting (swyno) ability for your warlock spells, so you use your Charisma (Presenoldeb) whenever a spell refers to your spellcasting (swyno) ability. In addition, you use your Charisma (Presenoldeb) modifier when setting the saving throw DC for a warlock spell you cast and when making an attack roll with one.
...
You can use an arcane focus as a spellcasting (swyno) focus for your warlock spells.
...
You learn the *find familiar (darganfod cynhalydd)* spell and can cast it as a ritual. The spell doesn't count against your number of spells known.
...
You gain proficiency in the Deception (Twyll) and Persuasion (Perswadio) skills.
...
| Spell Level | Spells                            |
|-------------|-----------------------------------|
| 1st         | burning hands (llaw llosgi), command (gorchymyn)            |
| 2nd         | blindness/deafness (dallu neu byddaru), scorching ray (peledr tân) |
| 3rd         | fireball (llosgbel), stinking cloud (cwmwl drewllyd)          |
| 4th         | fire shield (aes) (armwr tân), wall of fire (tânfur)         |
| 5th         | flame strike (awyrdan), hallow (sancteiddio)              |
|             |                                   |
...
>
>***Pact of the Blade***. If your patron is the Archfey, your weapon might be a slender blade wrapped in leafy vines. If you serve the Fiend, your weapon could be an axe made of black metal and adorned with decorative flames. If your patron is the Great Old One, your weapon might be an ancient-looking spear, with a gemstone embedded in its head, carved to look like a terrible unblink (blinc)ing eye.
>
