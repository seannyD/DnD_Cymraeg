...
**Dis Heini:** 1d6 per sorcerer level

**Pwyntiau Heini ar lefel 1:** 6 + eich newidyn Cyfansoddiad

**Pwyntiau Heini ar lefelau uwch:** 1d6 (or 4) + eich newidyn Cyfansoddiad per sorcerer level after 1st
...
**Sgiliau:** Dewiswch dau o Hud a Lledrith, Twyll, Mewnwelediad, Brawychu, Perswadio, ac Crefydd
...
Charisma (Presenoldeb) is your spellcasting (swyno) ability for your sorcerer spells, since the power of your magic relies on your ability to project your will into the world. You use your Charisma (Presenoldeb) whenever a spell refers to your spellcasting (swyno) ability. In addition, you use your Charisma (Presenoldeb) modifier when setting the saving throw DC for a sorcerer spell you cast and when making an attack roll with one.
...
To be eligible, a spell must be incapable of targeting more than one creature at the spell's current level. For example, *magic missile (saeth hud)* and *scorching ray (peledr tân)* aren't eligible, but *ray of frost (pelydr rhew)* and *chromatic orb* are.
...
Starting at 6th level, when you cast a spell that deals damage of the type associated with your draconic ancestry, you can add your Charisma (Presenoldeb) modifier to one damage roll of that spell. At the same time, you can spend 1 sorcery point to gain resistance (gwrthiant) to that damage type am un awr.
