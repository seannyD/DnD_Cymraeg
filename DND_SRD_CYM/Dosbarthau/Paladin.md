...
**Dis Heini:** 1d10 per paladin level

**Pwyntiau Heini ar lefel 1:** 10 + eich newidyn Cyfansoddiad

**Pwyntiau Heini ar lefelau uwch:** 1d10 (or 6) + eich newidyn Cyfansoddiad per paladin level after 1st
...
- Chain mail and a holy symbol (glyff)
...
Your bless (bendigo)ed touch can heal (iacháu) wounds. You have a pool of heal (iacháu)ing power that replenishes when you take a long rest. With that pool, you can restore a total number of hit points equal to your paladin level × 5.
...
***Courage***. Never fear (braw) to act, though caution is wise.
...
|-------|------------------------------------------|
| 3rd   | protection from evil and good (gwarchod o dda a drwg), sanctuary (cysegr) |
| 5th   | lesser restoration (adfer bach), zone of truth (parth gwirionedd)        |
| 9th   | beacon of hope (begwn gobaith), dispel magic (dadswyno)             |
| 13th  | freedom of movement (symud rhydd), guardian of faith (gwarcheidwad ffydd)   |
| 17th  | commune (ymgomino), flame strike (awyrdan)                    |
|       |                                          |
