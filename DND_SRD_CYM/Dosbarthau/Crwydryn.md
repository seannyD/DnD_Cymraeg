...
**Dis Heini:** 1d10 per ranger level

**Pwyntiau Heini ar lefel 1:** 10 + eich newidyn Cyfansoddiad

**Pwyntiau Heini ar lefelau uwch:** 1d10 (or 6) + eich newidyn Cyfansoddiad per ranger level after 1st
...
**Sgiliau:** Dewiswch tri o Trin Anifeiliaid (cymorth), Athletig, Mewnwelediad, Ymchwilio, Natur, Canfyddiad, Tawel, ac Goroesi
...
You have advantage on Wisdom (Doethder) (Survival (Goroesi)) checks to track your favored enemies, as well as on Intelligence (Deallusrwydd) checks to recall information about them.
...
By the time you reach 2nd level, you have learned to use the magical essence of nature to cast spells, much as a druid does. See the general rules for spellcasting (swyno) and the ranger spell list.
...
***Evasion***. When you are subjected to an effect, such as a red dragon's fiery breath or a *light (golau)ning bolt* spell, that allows you to make a Dexterity (Chwimder) saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.
